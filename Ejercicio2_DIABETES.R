...
COVID19MEXICO_20211115 <- read_csv("C:\\Users\\citla\\Downloads\\211115COVID19MEXICO.csv",
...
#   de la prueba
#===================================================    
survfit(Surv(TIEMPO,CENSURA)~DIABETES_L,
        data=COVID19_FILTRADO_20211115%>%filter(CENSURA==1 ) )->covid.table.diabetes

summary(covid.table.diabetes)


autoplot(covid.table.diabetes, xlab='Tiempo dias', ylab='Probabilidad de supervivencia ',
         lty=1:2)

autoplot(covid.table.diabetes, xlab='Tiempo dias', ylab='Probabilidad acumulada de riesgo ',
         lty=1:2, fun = "cumhaz")

survdiff(Surv(TIEMPO,CENSURA)~DIABETES_L,
